// To parse this data:
//
//   import { Convert, Animapp } from "./file";
//
//   const animapp = Convert.toAnimapp(json);
//
...
export class Convert {
    public static toAnimapp(json: string): IAnimapp {
        return cast(JSON.parse(json), r("Animapp"));
    }

    public static animappToJson(value: IAnimapp): string {
        return JSON.stringify(uncast(value, r("Animapp")), null, 2);
    }
}
